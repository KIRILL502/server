...
function GuiInitialize()
	...
	g_GuiLabel.Speed = dxText:create("0", screenWidth-72, screenHeight - 36, false, font_bs_nfsw, 0, "right")
	g_GuiLabel.Speed:type("stroke", 3, 0, 0, 0, 255)
	
	g_GuiLabel.Unit = dxText:create("", screenWidth-64, screenHeight - 28, false, font_bs_nfsw, 0, "left")
